  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-4">
        ...
        <div className="mt-2 grid grid-cols-4 gap-4 text-sm">
          ...
          <div>
            ...
            <span
              style={{ color: bullishRatio > 50 ? colors.bullish : colors.bearish }}
              className="font-bold"
            >
      ...
      <div className="mt-4 rounded-lg bg-gray-800 p-3 text-xs text-gray-400">
        ...
        <br />
        <span style={{ color: colors.bullish }}>● 양봉(초록)</span>: 변동성이 증가하는 구간 → 가격이
        더 불안정해짐
        <br />
        <span style={{ color: colors.bearish }}>● 음봉(빨강)</span>: 변동성이 감소하는 구간 → 가격이
        안정화됨
        <br />
        <br />
        <strong>💡 이 프로젝트의 핵심:</strong> 변동성의 변동성을 추적하여 시장의 불확실성을
        측정합니다.
      </div>
    </div>
  );
