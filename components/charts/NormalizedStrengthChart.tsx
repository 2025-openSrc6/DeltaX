...
export default function NormalizedStrengthChart({
    ...
    const fetchData = async () => {
        try {
            ...
            const chartData = slicedData.map((item: any) => ({
        ...
        <div className="w-full">
            ...
            <div className="mb-4 grid grid-cols-3 gap-4">
                <div className="rounded-lg bg-gray-800/50 p-3">
                    ...
                    <div className={`text-2xl font-bold ${stats.paxgCurrent >= 1 ? 'text-green-400' : 'text-gray-300'}`}>
                ...
                <div className="rounded-lg bg-gray-800/50 p-3">
                    ...
                    <div className={`text-2xl font-bold ${stats.btcCurrent >= 1 ? 'text-orange-400' : 'text-gray-300'}`}>
                ...
                <div className="rounded-lg bg-gray-800/50 p-3">
                    ...
                    <div className={`text-2xl font-bold ${stats.winner === 'PAXG' ? 'text-green-400' : stats.winner === 'BTC' ? 'text-orange-400' : 'text-gray-400'}`}>
                        {stats.winner === 'TIE' ? '동률' : stats.winner}
                    </div>
                    <div className="text-xs text-gray-500">
                        격차: {Math.abs(stats.spread).toFixed(2)}
                    </div>
                </div>
            </div>
